...
# Firth Model - Sex + Age, removing the unconscious birds
```{r}
# Remove unconscious individuals 

AHDB_Exp1_MS1_unc <- AHDB_Exp1_MS1[
  !AHDB_Exp1_MS1$ID_Band %in% c("4817", "4531"),
]

firth_fit_sex_age_unc <- logistf(Died_InTrt ~  Sex + AgeCategory, #+ Sex*AgeCategory,  
                            data = AHDB_Exp1_MS1_unc)
summary(firth_fit_sex_age_unc)
#Age & Sex interaction was removed by backward regression 

exp(coef(firth_fit_sex_age_unc)) 
exp(confint(firth_fit_sex_age_unc))

# Result:
# Sex p= 7.039963e-02 = 0.07
# Age p= 1.842529e-02 = 0.018*
```
