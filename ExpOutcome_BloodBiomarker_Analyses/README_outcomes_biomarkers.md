...
- [AHDB1_Manuscript1_Deaths_Multiplex_2025-08-01 13-38-10_795BR20744 -  Quantification Cq Results.csv](https://github.com/Schwartz-Lab-at-Auburn/ZebraFinch_ReducedHeatTolerance_in_PubescentFemales/blob/main/ExpOutcome_BloodBiomarker_Analyses/AHDB1_Manuscript1_Deaths_Multiplex_2025-08-01%2013-38-10_795BR20744%20-%20%20Quantification%20Cq%20Results.csv) : This is the file from the qPCR software that is produced for the Cq quantification following the multiplex reaction of an autosomal gene (EEF2) and the mtDNA gene (ND5). 
- [AHDB1_Manuscript1_Deaths_Telomere_Heidinger_2025-08-01 11-52-51_795BR20744 -  Quantification Cq Results.csv](https://github.com/Schwartz-Lab-at-Auburn/ZebraFinch_ReducedHeatTolerance_in_PubescentFemales/blob/main/ExpOutcome_BloodBiomarker_Analyses/AHDB1_Manuscript1_Deaths_Telomere_Heidinger_2025-08-01%2011-52-51_795BR20744%20-%20%20Quantification%20Cq%20Results.csv) : This is the file from the qPCR software that is produced for the Cq quantification following the telomere reaction.


## R Code
- [AHDB_MS1_Data_PreProcessing.R](https://github.com/Schwartz-Lab-at-Auburn/ZebraFinch_ReducedHeatTolerance_in_PubescentFemales/blob/main/ExpOutcome_BloodBiomarker_Analyses/AHDB_MS1_Data_PreProcessing.R) : This R code processes and then merges the raw data into a meta data file for usage in the analysis.
- [AHDB_Exp1_MS1_Analysis.Rmd](https://github.com/Schwartz-Lab-at-Auburn/ZebraFinch_ReducedHeatTolerance_in_PubescentFemales/blob/main/ExpOutcome_BloodBiomarker_Analyses/AHDB_Exp1_MS1_Analysis.Rmd) : This R Markdown is the analysis. First, the analysis of the deaths observed, predicted proportion of deaths, and whether there is a significant effect of sex and age category. Then, the analysis of the potential biomarkers of glucose, ketone, hematocrit, telomere length, and mtDNA copy number. The potential biomarker data is from baseline blood samples taken 14 days prior to an acute heat stress event (43°C for 5 hours). This dataset contains samples from younger adult females that survived this treatment, as well as individuals that died to test whether any biomarkers were predictive of this future fate.


## Input Data
For the AHDB_Exp1_MS1_Analysis.Rmd : 
- [AHDB_Exp1_MS1.csv](https://github.com/Schwartz-Lab-at-Auburn/ZebraFinch_ReducedHeatTolerance_in_PubescentFemales/blob/main/ExpOutcome_BloodBiomarker_Analyses/AHDB_Exp1_MS1.csv) : This is the meta data file containing all potential biomarker metrics and specifying the samples of interest by their ID_Band. Indicated by the Died_InTrt column we have whether they did "yes" or did not died "no" due to heat stress. Other important metrics such as AgeCategory, Sex, and Treatment are included.  
