...
- [AHDB_Exp1_MS1_Analysis.Rmd](https://github.com/Schwartz-Lab-at-Auburn/ZebraFinch_ReducedHeatTolerance_in_PubescentFemales/blob/main/ExpOutcome_BloodBiomarker_Analyses/AHDB_Exp1_MS1_Analysis.Rmd) : This R Markdown is the analysis. First, the analysis of the deaths observed, predicted proportion of deaths, and whether there is a significant effect of sex and age category. Then, the analysis of the potential biomarkers of glucose, ketone, hematocrit, CORT, telomere length, and mtDNA copy number. The potential biomarker data is from baseline blood samples taken 14 days prior to an acute heat stress event (43°C for 5 hours). This dataset contains samples from younger adult females that survived this treatment, as well as individuals that died to test whether any biomarkers were predictive of this future fate.
